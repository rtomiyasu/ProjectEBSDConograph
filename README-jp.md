...
- Example 1: [out.txt](https://github.com/rtomiyasu/ProjectEBSDConograph/blob/main/EBSDConograph_0_9_99_win/sample/Fe(three_columns,use_band_widths)/output/out.txt) (バンド幅を用いた場合)
- Example 2: [out.txt](https://github.com/rtomiyasu/ProjectEBSDConograph/blob/main/EBSDConograph_0_9_99_win/sample/Fe(four_columns,use_only_band_centers)/output/out.txt) (φ, σのみを用いた場合)
